...
extern double InitTime, InputTime;
...
extern double Omega, OmegaLambda, OmegaRadiation, OmegaDM_2ndSpecies, Sigma8;
extern double OmegaBaryon, HubbleParam, Z_eq;
extern double PrimordialIndex;
extern double ShapeGamma;

extern double Dplus; /* growth factor */
extern double DplusDEBA18(double k, double astart, double aend);
extern inline double DEBA18_prefac(double k, double a);
